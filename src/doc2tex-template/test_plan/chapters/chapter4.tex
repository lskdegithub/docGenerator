...
\vspace{6pt}
\centerline{\wuhaohei 表 9 计划的测试顺序}
\vspace{6pt}
{\settablespacing
\begin{longtable}{|p{0.5cm}|p{4cm}|p{3cm}|p{3.5cm}|p{3.5cm}|}
\hline
\rowcolor{gray!20}
...
\vspace{6pt}
\centerline{\wuhaohei 表 10 测试项列表}
\vspace{6pt}
{\settablespacing
\begin{longtable}{|p{1cm}|p{4cm}|p{3cm}|p{6.5cm}|}
\hline
\rowcolor{gray!20}
...
\BeginTestItemTable{11}{基于PQL查询语言的血缘演算功能测试}
\TestItemFirstRow{6cm}{大文件存储xxx大文件存储xxx}{5.5cm}{bigfilestorage1}
\TestItemRow{测试要求}{3}{13cm}{测试项的测试要求}
\TestItemRow{测试策略与方法}{3}{13cm}{测试策略：测试策略描述\newline 测试方法：测试方法描述}
\TestItemRow{假设与约束}{3}{13cm}{假设：测试项的假设\newline 约束：测试项的约束}
\TestItemRow{优先级}{3}{13cm}{高}
\TestItemRow{测试终止条件}{3}{13cm}{测试项的终止条件}
\TestItemRow{追踪关系}{3}{13cm}{SRS-01}
\EndTestItemTable
