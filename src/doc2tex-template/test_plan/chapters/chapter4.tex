...
\centering
\vspace{6pt}
{\wuhaohei 表 11 {\wuhaohei 基于PQL查询语言的血缘演算功能测试}}

\vspace{6pt}
{\settablespacing
\begin{tabular}{|p{2.3cm}|p{6cm}|p{0.7cm}|p{5.5cm}|}
\hline
\xiaowuhei 测试项名称 & \parbox[t]{6cm}{{\xiaowu 大文件存储xxx大文件存储xxx}} & \xiaowuhei 标识 & \parbox[t]{5.5cm}{{\xiaowu \ttfamily bigfilestorage1}} \\
\hline
\xiaowuhei 测试要求 & \multicolumn{3}{p{13cm}|}{ \xiaowu 测试项的测试要求} \\
\hline
\xiaowuhei 测试策略与方法 & \multicolumn{3}{p{13cm}|}{ \xiaowu 测试策略：测试策略描述\newline 测试方法：测试方法描述} \\
\hline
\xiaowuhei 假设与约束 & \multicolumn{3}{p{13cm}|}{\xiaowu 假设：测试项的假设\newline 约束：测试项的约束} \\
\hline
\xiaowuhei 优先级 & \multicolumn{3}{p{13cm}|}{\xiaowu 高} \\
\hline
\xiaowuhei 测试终止条件 & \multicolumn{3}{p{13cm}|}{\xiaowu 测试项的终止条件} \\
\hline
\xiaowuhei 追踪关系 & \multicolumn{3}{p{13cm}|}{\xiaowu SRS-01} \\
\hline
\end{tabular}
}
\end{table}
