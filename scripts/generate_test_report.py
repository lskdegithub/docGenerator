...
from utils import escape_latex, format_title_name_ident as shared_format_title_name_ident
...
def format_title_name_ident(name: str, ident: str, section_number: str, page_width_cm: float = 15.5) -> str:
    _ = section_number
    _ = page_width_cm
    return shared_format_title_name_ident(name, ident)
...
def generate_chapter4_content(test_items, output_dir):
    ...
    for item in test_items:
        ...
        lines.append(r"}")
        lines.append(r"\SetCell[c=2]{halign=c}{\TableKeyCell{测试用例名称}} & & \SetCell[c=3]{valign=t}{（测试用例名称）} &  &  & \SetCell{halign=c}{\TableKeyCell{标识}} & \SetCell[c=2]{halign=c,valign=t}{{\xiaowu\ttfamily （标识）}} & \\")
        ...
        lines.append(r"\SetCell{font=\xiaowuhei,halign=c,valign=m}{序号} & \SetCell[c=3]{font=\xiaowuhei,halign=c,valign=m}{输入及操作} &  &  & \SetCell[c=3]{font=\xiaowuhei,halign=c,valign=m}{期望结果} &  &  & \SetCell{wd=\GjbDetailCaseStepsResultWidth,font=\xiaowuhei,halign=c,valign=m}{测试结果} \\")
        lines.append(r"1 & \SetCell[c=3]{valign=t}{（输入及操作）} &  &  & \SetCell[c=3]{valign=t}{（期望结果）} &  &  & \SetCell{wd=\GjbDetailCaseStepsResultWidth,valign=t}{} \\")
        lines.append(r"2 & \SetCell[c=3]{valign=t}{（输入及操作）} &  &  & \SetCell[c=3]{valign=t}{（期望结果）} &  &  & \SetCell{wd=\GjbDetailCaseStepsResultWidth,valign=t}{} \\")
        ...
        lines.append(r"\SetCell[c=2]{halign=c}{\TableKeyCell{设计人员}} & & \SetCell[c=3]{valign=t}{（设计人员）} &  &  & \SetCell{halign=c,valign=m}{\TableKeyCell{操作人员}} & \SetCell[c=2]{halign=c,valign=m}{（操作人员）} & \\")
        lines.append(r"\SetCell[c=2]{halign=c}{\TableKeyCell{测试人员}} & & \SetCell[c=3]{valign=t}{（测试人员）} &  &  & \SetCell{halign=c,valign=m}{\TableKeyCell{测试时间}} & \SetCell[c=2]{halign=c,valign=m}{（测试时间）} & \\")
        lines.append(r"\end{longtblr}}")
        lines.append(r"\vspace{0pt}")
        lines.append("")
